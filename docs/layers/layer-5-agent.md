...
| Same-Host Resource Worker Transform; contained Process on verified macOS; Codex-derived Windows adapter gated by its native runtime conformance probe | Product-configured executable binding; native packaged Windows proof; Linux process world |
