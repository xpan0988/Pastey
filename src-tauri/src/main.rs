...
use crate::{
    commands::{
        ...
        delete_temp_file, deny_developer_terminal, discard_native_agent_conflict_result,
        ...
        get_file_transfer_metadata, get_last_benchmark_results,
        get_managed_worker_provider_settings, get_native_agent_recovery_projection,
        ...
        start_bridge_plan_attempt, start_native_codex_task, start_native_v2_plan_attempt,
        start_remote_native_codex_task, stop_bridge_native_agent_task, update_config,
...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_native_agent_recovery_projection,
            reveal_native_agent_conflict_result,
            discard_native_agent_conflict_result,
