...
use crate::{
    commands::{
        ...
        approve_remote_native_codex_workspace_movement, bind_bridge_plan_to_session, burn_room,
        cancel_native_agent_task, cancel_native_v2_plan_attempt, cancel_remote_native_agent_task,
        cancel_transfer, check_for_updates, check_managed_worker_provider_health,
        close_developer_terminal, compose_native_v2_plan, compose_natural_v2_candidate,
        confirm_capability_acquisition, copy_last_error, copy_text_to_clipboard,
        create_composed_file_bridge_plan, create_direct_file_transfer_bridge_plan,
        create_managed_worker_provider, create_room, delete_managed_worker_provider,
        delete_temp_file, deny_developer_terminal, enter_developer_mode,
        get_bridge_node_list_projection, get_config, get_developer_terminal_workspace,
        get_device_capabilities, get_device_profile, get_file_transfer_metadata,
        get_last_benchmark_results, get_managed_worker_provider_settings,
        get_native_agent_task_status, get_native_agent_workspace_movement_status,
        get_native_v2_plan_status, get_room, get_room_control_session_context, join_room,
        list_bridge_plan_workspace, list_managed_runtime_options, list_native_agent_capabilities,
        ...
        reveal_in_folder, revoke_bridge_peer_pairing, run_bridge_device_diagnostics,
        run_bridge_device_self_check, run_loopback_benchmark, run_peer_link_benchmark,
        select_bridge_plan_search_candidate, select_managed_execute_runtime,
        select_managed_worker_provider, send_developer_terminal_input, send_file_to_room,
        send_text_to_room, start_bridge_plan_attempt, start_native_codex_task,
        start_native_v2_plan_attempt, start_remote_native_codex_task, update_config,
        update_managed_worker_provider, update_transfer_window, withdraw_bridge_plan_revision,
        write_temp_file,
    },
...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            start_remote_native_codex_task,
            cancel_remote_native_agent_task,
            propose_remote_native_codex_workspace_movement,
            approve_remote_native_codex_workspace_movement,
            get_native_agent_workspace_movement_status,
            retry_native_agent_workspace_result_return,
            reconcile_remote_native_agent_task,
